...
def page_Acquire():
    ...
    with bcol1:
        ...
        if reset_button:
            reset_data()
    with bcol2:
        acquire_button = st.button("Acquire Data and Retrain")
        if acquire_button:
            acquire()
...
def sideBar():
    with st.sidebar:
        selected=option_menu(
            ...
            options=["Live Design","Design","Acquire","Analyses", "Bonus"], #Charting / info-circle / graph-up
